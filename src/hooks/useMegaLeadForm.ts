...
/**
 * useMegaLeadForm — Collision Center Orlando LP form submission hook.
 * Reference: landing-page-forms skill.
 *
 * Customer ID is the real one from Atlas. SITE_ID is a placeholder until the
 * Mega Admin Owned-Site row is created during deploy (landing-page-deploy 3e).
 */
  ...
  const submit = useCallback(
    async (
      ...
      const payload: SubmissionPayload = {
        ...
        source_provider: options.sourceProvider ?? "collision-center-orlando-landing",
        form_data: formData,
